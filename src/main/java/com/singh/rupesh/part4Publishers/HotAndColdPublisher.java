...
public class HotAndColdPublisher {
    ...
    public static void main(String[] args) {
        ...
        Flux<String> movieStream = Flux.fromStream(() -> getMovie())
                ...
                .refCount(2);
                //.share(); // this function when applied makes the publisher change from cold to hot ie.. multicast the same content to all subscribers.
        ...
        // if refCount value is 1 and one subscriber finishes consuming the data and some other
